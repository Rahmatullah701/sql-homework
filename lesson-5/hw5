...
1. SELECT SaleID, SaleAmount,
   ...
   END AS Tier
   FROM Sales;
2.SELECT CustomerID FROM Orders
  EXCEPT
  SELECT CustomerID FROM Sales;
3.SELECT CustomerID, Quantity,
  CASE
  ...
  --We can also return it as a numeric value if needed
